# Code taken from https://github.com/microsoft/unilm/blob/master/deltalm/deltalm/models/deltalm.py
...
class DeltaLMModel(TransformerModel):
    ...
    def build_encoder(cls, args, tgt_dict, embed_tokens):
        return DeltaLMEncoder(args, tgt_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        return DeltaLMDecoder(args, tgt_dict, embed_tokens)


class DeltaLMEncoder(TransformerEncoder):
...
class DeltaLMDecoder(TransformerDecoder):
...
class DeltaLMDecoderLayer(TransformerDecoderLayer):
...
def base_architecture_deltalm(args):
...
def large_architecture_deltalm(args):
